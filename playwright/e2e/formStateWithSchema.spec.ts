...
test.describe('form state with schema validation', () => {
  test.skip('should return correct form state with onSubmit mode (3)', async ({
    page,
  }) => {
  ...
  test.skip('should return correct form state with onChange mode (2)', async ({
    page,
  }) => {
  ...
  test.skip('should return correct form state with onBlur mode (2)', async ({
    page,
  }) => {
  ...
  test.skip('should reset dirty value when inputs reset back to default with onSubmit mode (2)', async ({
    page,
  }) => {
  ...
  test.skip('should reset dirty value when inputs reset back to default with onBlur mode (2)', async ({
    page,
  }) => {
    await page.goto('http://localhost:3000/formState/onBlur');
  ...
  test.skip('should reset dirty value when inputs reset back to default with onChange mode (2)', async ({
    page,
  }) => {
    await page.goto('http://localhost:3000/formState/onChange');
