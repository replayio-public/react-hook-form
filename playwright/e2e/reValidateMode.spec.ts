...
test.describe('re-validate mode', () => {
  test.skip('should re-validate the form only onSubmit with mode onSubmit and reValidateMode onSubmit', async ({
    page,
  }) => {
  ...
  test.skip('should re-validate the form only onBlur with mode onSubmit and reValidateMode onBlur', async ({
    page,
  }) => {
  ...
  test.skip('should re-validate the form only onSubmit with mode onBlur and reValidateMode onSubmit', async ({
    page,
  }) => {
  ...
  test.skip('should re-validate the form only onSubmit with mode onChange and reValidateMode onSubmit', async ({
    page,
  }) => {
  ...
  test.skip('should re-validate the form onBlur only with mode onBlur and reValidateMode onBlur', async ({
    page,
  }) => {
  ...
  test.skip('should re-validate the form onChange with mode onBlur and reValidateMode onChange', async ({
    page,
  }) => {
