...
test.describe('useFieldArray', () => {
  ...
  test.skip('should behaviour correctly with defaultValue', async ({ page }) => {
  ...
  test.skip('should behaviour correctly with defaultValue and without auto focus', async ({
    page,
  }) => {
    await page.goto(
  ...
  test.skip('should display the correct dirty value with default value - #1', async ({
    page,
  }) => {
    await page.goto('http://localhost:3000/useFieldArray/default');
  ...
  test.skip('should display correct error with the inputs', async ({ page }) => {
    await page.goto('http://localhost:3000/useFieldArray/default');
    await page.click('#prepend');
    await page.fill('#field1', '');
    await page.fill('#field2', '');
  ...
  test.skip('should return correct touched values', async ({ page }) => {
    await page.goto('http://localhost:3000/useFieldArray/default');
  ...
  test.skip('should return correct touched values without autoFocus', async ({
    page,
  }) => {
    await page.goto(
      'http://localhost:3000/useFieldArray/defaultAndWithoutFocus',
  ...
  test.skip('should return correct isValid formState', async ({ page }) => {
