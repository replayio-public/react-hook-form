...
test.describe('form setError', () => {
  test.skip('should contain 3 errors when page land', async ({ page }) => {
  ...
  test.skip('should clear individual error', async ({ page }) => {
    await page.goto('http://localhost:3000/setError');
  ...
  test.skip('should clear an array of errors', async ({ page }) => {
    await page.goto('http://localhost:3000/setError');
  ...
  test.skip('should clear every errors', async ({ page }) => {
    await page.goto('http://localhost:3000/setError');
