...
test.describe('isValid', () => {
  test.skip('should showing valid correctly with build in validation', async ({
    page,
  }) => {
  ...
  test.skip('should showing valid correctly with build in validation and default values supplied', async ({
    page,
  }) => {
  ...
  test.skip('should showing valid correctly with schema validation', async ({
    page,
  }) => {
  ...
  test.skip('should showing valid correctly with schema validation and default value supplied', async ({
    page,
  }) => {
