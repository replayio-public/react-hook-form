...
test.describe('useWatch', () => {
  test.skip('should only trigger render when interact with input 1', async ({
    page,
  }) => {
  ...
  test.skip('should only trigger render when interact with input 2', async ({
    page,
  }) => {
    await page.goto('http://localhost:3000/useWatch');
  ...
  test.skip('should only trigger render when interact with input 3', async ({
    page,
  }) => {
    await page.goto('http://localhost:3000/useWatch');
