...
test.describe('controller basic form validation', () => {
  test('should validate the form and reset the form (2)', async ({ page }) => {
 ...
 // await expect(page.locator('#renderCount')).toHaveText('8');
  ...
  test('should validate the form with onBlur mode and reset the form (2)', async ({ page }) => {
...
// await expect(page.locator('p')).toHaveCount(0);
 ...
 // await expect(page.locator('#renderCount')).toHaveText('9');
  ...
  test('should validate the form with onChange mode and reset the form (2)', async ({ page }) => {
